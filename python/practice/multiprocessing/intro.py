...
def main():
    ...
    e = Process(target=counter, args=(25000000,))
    f = Process(target=counter, args=(25000000,))
    g = Process(target=counter, args=(25000000,))
    h = Process(target=counter, args=(25000000,))
