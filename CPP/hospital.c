...
int resetpwd(int opt)
{
    ...
    do
    {
        ...
        {
            sh = 1;
            notice(">Password too short<", 24, 10, 55, 15);
            blockey();
            continue;
        }
        if (atol(code) != 111110)
        {
            ...
            gotoxy(5, 2);
            textcolor(15);
            cprintf(">PLEASE ENTER CORRECT CODE OF PROGRAM<");
            gotoxy(3, 3);
            printf("<You have %02d more time to set User Login>", 2 - t);
            gotoxy(22, 6);
            textbackground(2);
            cprintf(" OK ");
            sh = 0;
...
int changepwd()
{
    ...
    do
    {
        ...
        textcolor(15);
        gotoxy(1, 4);
        cprintf("Enter Old Username:");
        gotoxy(1, 6);
        cprintf("Enter Old Password:");
        gotoxy(21, 4);
        strcpy(ousr, input(2, 30, 3));
        if (strcmp(ousr, "00") == 0)
        {
            s = 0;
            break;
        ...
        if (strcmp(log.usr, ousr) != 0 || strcmp(log.pwd, opwd) != 0)
        {
            ...
            gotoxy(2, 3);
            printf("<You have %d more time to reset User Login>", 2 - t);
            gotoxy(22, 6);
            textbackground(2);
            cprintf(" OK ");
...
int login(int n)
{
    ...
    do
    {
        ...
        gotoxy(21, 8);
        printf("Please Enter Login Information to Start");
        box(2, 2, 79, 24, 15);
        gotoxy(30, 12);
        textcolor(15);
        cprintf("Username:");
        ...
        if (strcmp(log.usr, usri) != 0 || strcmp(log.pwd, pwdi) != 0)
        {
            gotoxy(25, 16);
            textcolor(15);
            cprintf(">Incorrect Username or Password<");
            gotoxy(27, 17);
            textcolor(15);
            cprintf("<You have %d more attempt(s)>", n - i - 1);
            gotoxy(15, 18);
            textcolor(15);
            cprintf("<<Press R to reset User Login or Enter to try again>>");
            i++;
            if (i >= n)
            {
                fclose(f_pwd);
...
void removeusr()
{
    ...
    do
    {
        ...
        if (strcmp(log.usr, usri) != 0 || strcmp(log.pwd, pwdi) != 0)
        {
            ...
            cprintf(">Incorrect Username or Password<");
            gotoxy(4, 3);
            printf("<You have %d more time to remove User Login>", 2 - i);
            gotoxy(24, 6);
            textbackground(2);
            cprintf(" OK ");
            i++;
...
int program()
{
    ...
    do
    {
        ...
        case -1:
            ...
            break;
        case 0:
            switch (dropmenu(menu1, 19, 4, 32, 8, 0))
            {
            case -2:
                close = 0;
                opt = 0;
...
int room()
{
    ...
    do
    {
        ...
        case 1:
            ...
            break;
        case 2:
            switch (dropmenu(menu1, 40, 6, 52, 11, 0))
            {
            case -2:
                close = 0;
                opt = 0;
            ...
            break;
        case 3:
            switch (dropmenu(menu2, 40, 7, 54, 11, 0))
            {
            case -2:
                close = 0;
                opt = 0;
    ...
    do
    {
        ...
        for (i = 0; i < 5; i++)
            if (i == select)
            {
                ...
                printf(" %s ", menu[i]);
        gotoxy(68, 1);
        printf("%02d/%02d/%d", da.da_day, da.da_mon, da.da_year);
        ch = getch();
        switch (ch)
        {
        case 75:
...
int doctor()
{
    ...
    do
    {
        ...
        case 0:
            ...
            break;
        case 1:
            switch (dropmenu(menu1, 21, 5, 39, 9, 0))
            {
            case -2:
                close = 0;
                opt = 0;
            ...
            break;
        case 2:
            switch (dropmenu(menu2, 21, 6, 39, 10, 0))
            {
            case -2:
                close = 0;
                opt = 0;
            ...
            break;
        case 3:
            switch (dropmenu(menu3, 21, 7, 38, 12, 0))
            {
            case -2:
                close = 0;
                opt = 0;
...
int patient()
{
    ...
    do
    {
        ...
        case 0:
            ...
            break;
        case 1:
            switch (dropmenu(menu1, 32, 5, 47, 10, 0))
            {
            case -2:
                close = 0;
                opt = 0;
            ...
            break;
        case 2:
            switch (dropmenu(menu2, 32, 6, 45, 10, 0))
            {
            case -2:
                close = 0;
                opt = 0;
            ...
            break;
        case 3:
            switch (dropmenu(menu3, 32, 7, 50, 12, 0))
            {
            case -2:
                close = 0;
                opt = 0;
...
void notice(char text[30], int x1, int y1, int x2, int y2)
{
    ...
    clrscr();
    drawbox(1, 1, x2 - x1 + 1, y2 - y1 + 1);
    gotoxy((x2 - x1 + 3) / 2 - strlen(text) / 2, 2);
    printf("%s", text);
    gotoxy((x2 - x1 + 2) / 2, 5);
    textbackground(2);
    cprintf(" OK ");
...
void notice(char text[2][30], int x1, int y1, int x2, int y2)
{
    ...
    clrscr();
    drawbox(1, 1, x2 - x1 + 1, y2 - y1 + 1);
    gotoxy((x2 - x1 + 3) / 2 - strlen(text[0]) / 2, 2);
    printf("%s", text[0]);
    gotoxy((x2 - x1 + 3) / 2 - strlen(text[1]) / 2, 3);
    printf("%s", text[1]);
    gotoxy((x2 - x1 + 2) / 2, 5);
    textbackground(2);
    cprintf(" OK ");
...
void drawwindow(char head[30], int x1, int y1, int x2, int y2, int c)
{
    ...
    clrscr();
    gotoxy(((x2 + 3) - (x1 - 3) + 3 - strlen(head)) / 2, 1);
    printf("%s", head);
    textbackground(c);
    textcolor(WHITE);
...
void addtype()
{
    ...
    s:
        ...
        textcolor(15);
        cprintf("Price: ");
        pri = inputf(10, 15); // problem with float
        if (pri == 0.0)
            break;
        type.co = code;
        strcpy(type.na, ty);
...
void checkoutinput(int opt)
{
    ...
    do
    {
        ...
        if (opt == 2)
        {
            ...
            textcolor(15);
            cprintf("First Name: ");
            strcpy(fname, input(2, 14, 15));
            if (strcmp(fname, "00") == 0)
                break;
            else
                strupr(fname);
            f_pat = fopen(_pati, "rb");
        ...
        if (opt == 3)
        {
            ...
            textcolor(15);
            cprintf("Last Name: ");
            strcpy(lname, input(2, 14, 15));
            if (strcmp(lname, "00") == 0)
                break;
            else
                strupr(fname);
            f_pat = fopen(_pati, "rb");
...
int checkout(char id[10])
{
    ...
    gotoxy(1, 1);
    printf("Name     : ");
    cprintf("%s %s", pat.fname, pat.lname);
    gotoxy(1, 3);
    printf("Sex      : ");
    cprintf("%c", pat.sex);
    gotoxy(1, 5);
    ...
    gotoxy(1, 7);
    printf("Type     : ");
    cprintf("%s", ro.type.na);
    gotoxy(1, 9);
    printf("Price    : ");
    cprintf("$%.2f/day", ro.type.pri);
    gotoxy(1, 11);
    printf("Date in  : ");
    cprintf("%02d/%02d/%d", pat.regi.day, pat.regi.mon, pat.regi.year);
    gotoxy(1, 13);
    printf("Date Out : ");
    cprintf("%02d/%02d/%d", gt->tm_mday, gt->tm_mon + 1, gt->tm_year + 1900);
    drawwindow("PAYMENT", 45, 11, 64, 16, 3);
    gotoxy(1, 2);
    printf("Other pay = $ ");
    pay = inputf(10, 15); // problem with float
    if (pay == 0.0)
    {
        goto end;
    }
...
void welc()
{
    ...
    clrscr();
    gotoxy(23, 3);
    printf("\x20\x5f\x20\x20\x20\x5f\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x5f\x20\x5f\x20\x20\x20\x20\x20\x20\x20\x20\x5f\x20");
    gotoxy(23, 22);
    printf("\x20\x20\x20\x20\x20\x20\x20\x7c\x5f\x5f\x5f\x2f");
    delay(100);
    gotoxy(23, 4);
    printf("\x7c\x20\x7c\x20\x7c\x20\x7c\x20\x5f\x5f\x5f\x20\x20\x5f\x5f\x5f\x5f\x20\x5f\x20\x5f\x5f\x20\x7c\x5f\x7c\x20\x7c\x5f\x20\x5f\x5f\x20\x5f\x7c\x20\x7c");
    gotoxy(23, 21);
    printf("\x7c\x5f\x5f\x5f\x5f\x2f\x20\x5c\x5f\x5f\x2c\x20\x7c\x5f\x5f\x5f\x5f\x2f\x5c\x5f\x5f\x5c\x5f\x5f\x5f\x5f\x7c\x5f\x7c\x20\x7c\x5f\x7c\x20\x7c\x5f\x7c");
    delay(100);
    gotoxy(23, 5);
    printf("\x7c\x20\x7c\x5f\x7c\x20\x7c\x2f\x20\x5f\x20\x5c\x2f\x20\x5f\x5f\x5f\x7c\x20\x27\x5f\x20\x5c\x7c\x20\x7c\x20\x5f\x5f\x2f\x20\x5f\x60\x20\x7c\x20\x7c");
    gotoxy(23, 20);
    printf("\x20\x5f\x5f\x5f\x29\x20\x7c\x20\x7c\x5f\x7c\x20\x5c\x5f\x5f\x5f\x20\x5c\x20\x7c\x7c\x20\x20\x5f\x5f\x5f\x2f\x20\x7c\x20\x7c\x20\x7c\x20\x7c\x20\x7c");
    delay(100);
    gotoxy(23, 6);
    printf("\x7c\x20\x20\x5f\x20\x20\x7c\x20\x28\x5f\x29\x20\x5c\x5f\x5f\x5f\x20\x5c\x20\x7c\x5f\x29\x20\x7c\x20\x7c\x20\x7c\x7c\x20\x28\x5f\x29\x20\x7c\x20\x7c");
    gotoxy(23, 19);
    printf("\x5c\x5f\x5f\x5f\x20\x5c\x7c\x20\x7c\x20\x7c\x20\x2f\x20\x5f\x5f\x5f\x7c\x20\x5f\x5f\x2f\x20\x5f\x5f\x20\x5c\x20\x27\x5f\x20\x60\x20\x5f\x20\x5c\x20");
    delay(100);
    gotoxy(23, 7);
    printf("\x7c\x5f\x7c\x20\x7c\x5f\x7c\x5c\x5f\x5f\x5f\x2f\x7c\x5f\x5f\x5f\x5f\x2f\x20\x20\x5f\x5f\x2f\x7c\x5f\x7c\x5c\x5f\x5f\x5c\x5f\x5f\x2c\x5f\x7c\x5f\x7c");
    gotoxy(23, 18);
    printf("\x2f\x20\x5f\x5f\x5f\x7c\x20\x5f\x20\x20\x20\x5f\x20\x5f\x5f\x5f\x5f\x7c\x20\x7c\x5f\x20\x5f\x5f\x5f\x5f\x20\x5f\x20\x5f\x5f\x20\x5f\x5f\x5f\x20\x20");
    delay(100);
    gotoxy(23, 8);
    printf("\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x7c\x5f\x7c");
    gotoxy(23, 17);
    printf("\x20\x5f\x5f\x5f\x5f\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x5f\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20");
    delay(100);
    gotoxy(9, 10);
    printf("");
    gotoxy(9, 15);
    printf("\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x20\x7c\x5f\x5f\x5f\x2f");
    delay(100);
    gotoxy(9, 11);
    printf("");
    gotoxy(9, 14);
    printf("");
    delay(100);
    gotoxy(9, 12);
    printf("");
    gotoxy(9, 13);
    printf("");
    delay(100);
    textbackground(15);
    window(7, 3, 10, 8);
    clrscr();
...
void patidetail(char id[10])
{
    ...
    for (i = 0; i < n; i++)
    {
        ...
        if (strcmp(id, pat.id) == 0)
        {
            ...
            cprintf("%02d/%02d/%d", pat.birth.da_day, pat.birth.da_mon, pat.birth.da_year);
            gotoxy(1, 13);
            printf("Address: ");
            cprintf("%s", pat.addr);
            gotoxy(30, 2);
            printf("Age: ");
            cprintf("%d", (da.da_mon >= pat.birth.da_mon && da.da_day >= pat.birth.da_day) ? (da.da_year - pat.birth.da_year) : (da.da_year - pat.birth.da_year - 1));
            gotoxy(30, 4);
            printf("Blood Group: ");
            cprintf("%s", pat.blo);
            gotoxy(30, 6);
...
int about()
{
    ...
    gotoxy(13, 4);
    textcolor(YELLOW);
    cprintf("Lecturer    : Heng Soman");

    gotoxy(13, 7);
    textcolor(9);
    cprintf("Created by  : SRUN VITOU");
    gotoxy(13, 9);
    textcolor(9);
    cprintf("Started     : Friday,3,April,2015");
    gotoxy(13, 11);
    textcolor(9);
    cprintf("Finished    : Monday,13,April,2015");
    gotoxy(13, 13);
    textcolor(9);
    cprintf("Version     : 1.0");
    while (blockey() == 13)
...
void docdetail(char id[10])
{
    ...
    for (i = 0; i < n; i++)
    {
        ...
        if (strcmp(id, doc.id) == 0)
        {
            ...
            textcolor(14);
            printf("Date of Birth: ");
            cprintf("%02d/%02d/%d", doc.birth.da_day, doc.birth.da_mon, doc.birth.da_year);
            gotoxy(1, 11);
            textcolor(14);
            printf("E-mail: ");
            cprintf("%s", doc.email);
            ...
            textcolor(14);
            printf("Age: ");
            cprintf("%d", (da.da_mon >= doc.birth.da_mon && da.da_day >= doc.birth.da_day) ? (da.da_year - doc.birth.da_year) : (da.da_year - doc.birth.da_year - 1));
            gotoxy(30, 4);
            textcolor(14);
            printf("Blood Group: ");
            cprintf("%s", doc.blo);
            ...
            cprintf("%02d/%02d/%d", doc.join.day, doc.join.mon, doc.join.year);
            break;
        }
    }
    fclose(f_pat);
...
void adddoc()
{
    ...
    date:
        ...
        textcolor(15);
        cprintf("E-mail: ");
        strcpy(email, input(3, 34, 15));
        if (strcmp(email, "00") == 0)
            break;
        gotoxy(1, 13);
        textcolor(15);
        cprintf("Address: ");
...
void deletedocinput(int opt)
{
    ...
    do
    {
        ...
        if (f == 1)
        {
            if (viewdoc(head, source, nf, 0) == 27)
                break;
            else
                continue;
        }
...
int viewpat(char head[30], Patient *source, int n, int opt)
{
    ...
    do
    {
        ...
        {
            gotoxy(1, i + 2);
            printf("%03d", source[i + s].ro);
            gotoxy(9, i + 2);
            printf("%s %s", source[i + s].fname, source[i + s].lname);
            gotoxy(25, i + 2);
            printf("%c", source[i + s].sex);
            gotoxy(31, i + 2);
            printf("%s", source[i + s].tel);
        }
    ch:
        ch = getch();
        switch (ch)
...
int viewdoc(char head[30], Doctor *source, int n, int opt)
{
    ...
    do
    {
        ...
        {
            gotoxy(1, i + 2);
            printf("%s", source[i + s].id);
            gotoxy(9, i + 2);
            printf("%s %s", source[i + s].fname, source[i + s].lname);
            gotoxy(25, i + 2);
            printf("%c", source[i + s].sex);
            gotoxy(31, i + 2);
            printf("%s", source[i + s].spec);
        }
    ch:
        ch = getch();
        switch (ch)
...
void findpat(int opt)
{
    ...
    do
    {
        ...
        if (opt == 2)
        {
            ...
            textcolor(15);
            cprintf("Name: ");
            strcpy(namef, input(2, 35, 15));
            if (strcmp(namef, "00") == 0)
                break;
            else
                strupr(namef);
            f_pat = fopen(_pati, "rb");
...
int viewroom(char head[30], Room *source, int n)
{
    ...
    do
    {
        ...
        {
            gotoxy(1, i + 2);
            printf("%03d", source[i + s].no);
            gotoxy(8, i + 2);
            printf("%s", source[i + s].type.na);
            gotoxy(18, i + 2);
            printf("%.2f", source[i + s].type.pri);
            gotoxy(30, i + 2);
            printf("%s", source[i + s].sta == 'n' ? "Available" : "Unavailable");
        }
    ch:
        ch = getch();
        switch (ch)
...
void findviewroom()
{
    ...
    do
    {
        ...
        if (n == 0)
        {
            gotoxy(5, 5);
            textcolor(15);
            cprintf("<There are no rooms to search>");
            blockey();
            break;
        }
        gotoxy(12, 5);
...
start:
    ...
    do
    {
        ...
        {
            gotoxy(1, i + 2);
            printf("%03d", source[i + s].co);
            gotoxy(19, i + 2);
            printf("%s", source[i + s].na);
            gotoxy(33, i + 2);
            printf("%.2f", source[i + s].pri);
        }
    ch:
        ch = getch();
        switch (ch)
